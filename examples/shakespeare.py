...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Shakespeare Text Generation Training Script"
    )
    ...
    parser.add_argument(
        "--backbone",
        type=str,
        default="CausalTransformer",
        help="Backbone architecture",
    )
    parser.add_argument(
        "--head", type=str, default="projection", help="Head architecture"
    )
    parser.add_argument(
        "--vocab-size",
        type=int,
        default=65,
        help="Vocabulary size (will be adjusted by dataset)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--block-size", type=int, default=64, help="Block size for training"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--project-name", type=str, default="TinyShakespeare", help="W&B project name"
    )
    parser.add_argument(
        "--run-name", type=str, default="shakespeare_transformer", help="W&B run name"
    )
