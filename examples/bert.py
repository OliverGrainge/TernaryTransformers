...
def parse_args():
    ...
    # Model configuration
    parser.add_argument('--backbone', type=str, default='Bert', help='Backbone architecture')
    ...
    parser.add_argument('--num-segments', type=int, default=2, help='Number of segments')
    ...
    parser.add_argument('--project-name', type=str, default='WikiText2-MLM', help='W&B project name')
...
def main():
    ...
    trainer = pl.Trainer(
        ...
        logger=pl.loggers.WandbLogger(project=args.project_name, name=module.experiment_name),
        callbacks=[
